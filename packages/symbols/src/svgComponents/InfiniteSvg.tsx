...
const InfiniteSvg: React.FC<JSX.IntrinsicElements['svg']> = (props) => (
  <svg
    {...props}
    viewBox='0 0 100 100'
    preserveAspectRatio='xMinYMin meet'
    className={mtgSymbolClasses.mana.root + ' ' + mtgSymbolClasses.mana.Inf}
  >
    <svg
      width={90}
      y={30}
...
export default memo(InfiniteSvg);
