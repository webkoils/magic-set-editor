...
const SplitMask2: React.FC<Record<string, never>> = () => {
  return (
    <defs>
...
const SplitMask3: React.FC<Record<string, never>> = () => {
  return (
    <defs>
...
const SplitMask: React.FC<{ size: number }> = ({ size }) => {
  switch (size) {
    case 2: {
      return <SplitMask2 />;
    }
