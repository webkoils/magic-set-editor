export const templateClasses = {
  ...
  topLine: {
    ...
    symbol: 'MseTopLine-Symbol',
    symbolBackground: 'MseTopLine-SymbolBackground',
  },
  typeLine: {
  ...
  textBox: {
    ...
    symbolBackground: 'MseTextBox-SymbolBackground',
    input: 'MseTextBox-Input',
  },
  artwork: { root: 'MseArtwork-Root' },
  input: { root: 'MseInput-Root' },
  symbol: { root: 'MseSymbol-Root' },
};
