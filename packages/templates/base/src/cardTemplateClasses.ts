import {
  ...
  MtgSymbolClasses,
  isMtgSymbolClass,
} from '@mse/ui.symbols/src/mtgSymbolClasses';
import {
  symbolInputClasses,
  SymbolInputClasses,
  isSymbolInputClass,
} from '@mse/ui.symbol-input/src/symbolInputClasses';
...
export type CardTemplateEntry = CSSObject & {
  symbol?: Partial<Record<keyof MtgSymbolClasses | `!${keyof MtgSymbolClasses}`, CSSObject>>;
  input?: Partial<Record<keyof SymbolInputClasses | `!${keyof SymbolInputClasses}`, CSSObject>>;
  state?: Partial<Record<keyof typeof cardStateClasses  | `!${keyof typeof cardStateClasses}`, CSSObject>>;
};
